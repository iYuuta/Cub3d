...
SRC_UTILS = utils/ft_exit.c utils/ft_error.c utils/ft_lstnew.c utils/ft_lstadd_back.c utils/ft_lstclear.c utils/ft_lstdelone.c \
...
SRC_PARSING = parsing/check_map.c parsing/print_map.c
